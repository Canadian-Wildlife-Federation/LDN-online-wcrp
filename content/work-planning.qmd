...
| Action | Lead | Support |
|---|---|---|
| Digitize 2025 field assessments | LDN | CWF |
| Review 2025 field results and determine next steps for assessed structures | LDN/CWF |  |
| Update connectivity models according to 2025 passage and habitat assessments | LDN | CWF |
| Complete in-depth passage assessments or habitat confirmations for data-deficient barriers | LDN |  |
| Assess 25-50 unassessed structures | LDN |  |
| Review field results and determine next steps for assessed structures | LDN/CWF |  |
| Update connectivity models according to 2026 passage and habitat assessments | LDN | CWF |
| Update written components of WCRP | LDN | CWF |

: Implementation plan for 2026-27 to close knowledge gaps and advance barrier rehabilitation to improve connectivity for Pacific Salmon in the LDN watersheds. Steps to incorporate field data, update models, and revise this WCRP are also included. {#tbl-table-8}
