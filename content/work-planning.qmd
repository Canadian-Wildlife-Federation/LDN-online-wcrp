...
#| label: tbl5
#| tbl-cap: 'Implementation plan for 2026-27 to close knowledge gaps and advance barrier rehabilitation to improve connectivity for Pacific Salmon in the LDN watersheds. Steps to incorporate field data, update models, and revise this WCRP are also included.'
#| warning: false
#| echo: false
